...
const file_transfer_proto_rawDesc = "" +
	...
	"\x0ecan_decompress\x18\x04 \x01(\bR\rcanDecompress\"J\n" +
	...
	"\n" +
	"StreamFile\x12\x1b.transfer.StreamFileRequest\x1a\x1c.transfer.StreamFileResponse0\x01B\x16Z\x14generated/transferpbb\x06proto3"
...
var file_transfer_proto_depIdxs = []int32{
	0, // 0: transfer.Transfer.GetFileSize:input_type -> transfer.GetFileSizeRequest
	2, // 1: transfer.Transfer.StreamFile:input_type -> transfer.StreamFileRequest
	1, // 2: transfer.Transfer.GetFileSize:output_type -> transfer.GetFileSizeResponse
	3, // 3: transfer.Transfer.StreamFile:output_type -> transfer.StreamFileResponse
